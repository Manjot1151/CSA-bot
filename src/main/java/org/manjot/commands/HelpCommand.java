...
public class HelpCommand extends Command implements CommandListener {
    ...
    private final String invite = "https://discord.com/api/oauth2/authorize?client_id=1150774993131679815&permissions=8&scope=bot%20applications.commands";
    private final String support = "https://discord.gg/[placeholder]";
    private final String vote = "https://top.gg/[placeholder]";
